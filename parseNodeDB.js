...
function parseNodeDB(){
	return new Promise(async (resolve, reject) => {
		...
		// https://sheetdb.io/api/v1/huo559h13730c
		if(setLang == "KR"){await axios.get('https://sheetdb.io/api/v1/y9y62rvt1j7i5?sheet=kr&sort_by=level&sort_order=asc').then( response => {
			...
			await axios.get('https://sheetdb.io/api/v1/y9y62rvt1j7i5?sheet=Sheet1&sort_by=level&sort_order=asc').then( response => {
				termDB = response.data;
