...
function parseNodeDB(){
	return new Promise(async (resolve, reject) => {
		...
		if(setLang == "KR"){await axios.get('https://sheetdb.io/api/v1/huo559h13730c?sheet=kr&sort_by=level&sort_order=asc').then( response => {
			...
			await axios.get('https://sheetdb.io/api/v1/huo559h13730c?sheet=Sheet1&sort_by=level&sort_order=asc').then( response => {
				termDB = response.data;
